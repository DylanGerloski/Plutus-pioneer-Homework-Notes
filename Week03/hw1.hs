...
mkValidator dat () ctx = traceIfFalse "case 1 failed" case1 || traceIfFalse "case 2 failed" case2
        where
                info :: TxInfo
                info = scriptContextTxInfo ctx

                case1 :: Bool
                case1 = (txSignedBy info $ beneficiary1 dat) && (contains (to $ deadline dat) $ txInfoValidRange info)

                case2 :: Bool
                case2 = (txSignedBy info $ beneficiary2 dat) && (contains (from $ deadline dat) $ txInfoValidRange info)
